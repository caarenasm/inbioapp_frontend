...
export class MisDatosPage implements OnInit {
  ...
  datos : { 
    genero: string, fechaNac: string, estatura: string, miObjetivo: string, pesoActual: string,
    pesoDeseado: string, imc: string, tdee: string, pcg: string,
    miPlan: string
  } = {
      genero: 'Masculino',
      fechaNac: '12.10.1978',
  ...
  consultas: { descripcion: string, icon: string, respuesta: string, resultado: string/*, resultado: any[]*/ }[] = [
    {
      descripcion: 'Estado del Sueño',
      icon: 'add',
      respuesta: 'Duermo muy bien y me levanto descansado',
      resultado: 'Bien por ti! Esto demuestra que la hormona del sueño está funcionando bien. Tu nutrición esta siendo adecuada para proveerte una calidad del sueño. Durante el sueño el organismo se regenera, se estimula el buen funcionamiento de los sistemas inmunitario y hormonal.'
